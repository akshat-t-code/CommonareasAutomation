...
describe("Activation Mailinator Account for Random New Sign up User ", function () {
  this.beforeEach(
    ...
    function () {
      ...
      cy.fixture("VerificationTestCasesData/AcceptRequestUserData").then(function (Email) {
        this.Credentials = Email;
        cy.log(Email)
        cy.log(this.Credentials.UserEmail);
      });

      cy.fixture("VerificationTestCasesData/RejectRequestUserData").then(function (Email2) {
  ...
  it.only("Verifying New User Email on Mailinator site for Accept Request", function () {
    //PageObject

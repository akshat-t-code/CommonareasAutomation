...
describe("Login for new User than Create A new Connection and Reject the Request ", function () {
    ...
    function () {
      ...
      cy.fixture("VerificationTestCasesData/RejectRequestUserData").then(
        function (JsonData) {
          ...
          cy.log(this.Credentials.UserEmail1);
          cy.log(this.Credentials.Fname1);
          cy.log(this.Credentials.Lname1);
        }
      );
    }
  );
  ...
  it("First Time Login into the appLication for New User", function () {
    ...
    sp.visit();
    lp.EnterEmail(this.Credentials.UserEmail1);
    ...
    cy.get(
      ...
      cy.log(WelcomeTxt);
      const username = this.Credentials.Fname1;
      cy.log(username);
      expect(username).eq(this.Credentials.Fname1);
      cy.wait(3000);
    });
  });
  ...
  it("Creating a new Connection ", function () {
    ...
    cy.ConnectionFirstName(this.Credentials.Fname1);
    cy.ConnectionLastName(this.Credentials.Lname1);
    cy.ConnectionEmail(this.Credentials.UserEmail1);

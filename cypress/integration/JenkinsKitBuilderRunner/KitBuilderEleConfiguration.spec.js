...
describe("Kit Builder All Data Elements Configuration", function () {
  ...
  it("Kit Builder Save and Publish", function () {
    ...
    cy.wait(5000);
    cy.screenshot("Input Section Ele Congif-done");
    cy.wait(5000);
  });
  ...
  it("Kit Builder Save and Publish", function () {
    ...
    cy.log("Kit builder(New Form) has been Published");
    cy.wait(5000);
    cy.screenshot("Date&Time Section Ele Congif-Done");
    cy.wait(5000);
  });
  ...
  it("Kit Builder Save and Publish", function () {
    ...
    cy.log("Kit builder(New Form) has been Published");
    cy.wait(5000);
    cy.screenshot("Choice&Pickers Section Ele Congif-Done");
    cy.wait(5000);
  });
  ...
  it("OneToOneRelation Data Type", function () {
    ...
    cy.wait(5000);
    cy.screenshot("Content Section Ele Congif-1");
    cy.wait(5000);
  });
  ...
  it("Inspection Data Type", function () {
    ...
    cy.wait(5000);
    cy.screenshot("Content Section Ele Congif-2");
    cy.wait(5000);
  });
  ...
  it("Link Data Type", function () {
    ...
    cy.wait(5000);
    cy.screenshot("Content Section Ele Congif-3");
    cy.wait(5000);
  });
  ...
  it("Kit Builder Save and Publish", function () {
    ...
    cy.log("Kit builder(New Form) has been Published");
    cy.wait(2000);
    cy.screenshot("Content Section Ele Congif-Done");
    cy.wait(5000);
  });

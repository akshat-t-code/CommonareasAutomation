...
describe("New kit item complete creation test case", function () {
  ...
  this.beforeEach("KitType Data", function () {
    ...
    cy.fixture("KitTypeTestData/SectionEleDataValues").then(function (
      SectionDataEle
    ) {
    ...
    cy.fixture("VerificationTestCasesData/SectionKitBuilderDataTypes2").then(
      function (SectionDataForElements) {
  ...
  it.only("Section Elements Configuration", function () {
    ...
    cy.get(
      "div.row.kit-related-form.pa-6 div.px-3.col.col-12:nth-child(35) div.kit-control-section.mb-3.v-item-group.theme--light.v-expansion-panels div.v-expansion-panel.v-expansion-panel--active.v-item--active div.v-expansion-panel-content div.v-expansion-panel-content__wrap div.v-card.v-sheet.theme--light div.v-card__text div.row div.kit-control-component.kit-control-measure.px-3.col.col-sm-12.col-md-6.mb-4.px-3.col-sm-12.col-md-6.mb-4.px-3:nth-child(8) div.row div.kit-control-measure--left.ma-0.pa-0.pr-2.col div.v-input.theme--light.v-text-field.v-text-field--is-booted.v-text-field--enclosed.v-text-field--outlined div.v-input__control div.v-input__slot > div.v-text-field__slot:nth-child(2)"
    )
      .click({ force: true })
    ...
    cy.get(
      ...
      .click({ force: true });
    //Select Date
    cy.xpath("//div[@class='v-btn__content'][contains(text(),'10')]")
      .first()
      .click({ force: true });
    cy.wait(2000);
    //Click on OK to save Date

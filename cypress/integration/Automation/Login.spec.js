...
it('Work Request kitType Form 1', function(){
...
cy.get('#inspire > div.v-application--wrap > div:nth-child(1) > div.root-container.fill-height.fill-width > div.base-layout-header.box > div > div > div.app-header-left-and-center.fill-height.col-md-5.col-lg-4.col-xl-3.col-12 > div > div > div > div > div > div.fill-height.d-flex.col.col-8 > div > div.plus-wrapper.fill-height.hidden-sm-and-down > div > button').click()
...
it('Work Request kitType Form 2 ', function(){
  ...
  //  cy.wait(60000)
    ...
    //cy.wait(60000)
    cy.get('.black--text').click();
    cy.get('.thumb-container:nth-child(3) .selected-icon').click({force:true});
    ...
    //file
    cy.get('.dropzone-area-button:nth-child(2)').scrollIntoView().click({force:true});
    cy.get('.thumb-container:nth-child(6) .selected-icon').click({force:true});
    cy.get('.container-search > .pop-up--header > .pop-up--header--right > .button-pop-ups--size > .v-btn__content').click({force:true})
...
it('Go to Work Request form HMB icon ',function(){
    ...
    cy.get('#inspire > div.v-application--wrap > div:nth-child(1) > aside > div.v-navigation-drawer__content > div > div > div:nth-child(22)').scrollIntoView().click({force:true})
    cy.wait(5000)
    //Click on Filter
    cy.get('.fill-height > .v-btn > .v-btn__content > .btn-nav > #Layer_1').click({force:true})
    ...
    cy.get('.row:nth-child(1) .v-list-item__subtitle:nth-child(3)').click({force:true});
